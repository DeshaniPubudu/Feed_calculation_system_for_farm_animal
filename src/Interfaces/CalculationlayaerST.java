 ...
 * @author gavishka
 */
public class CalculationlayaerST extends javax.swing.JFrame {

    Connection conn= null;
    
    public CalculationlayaerST() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(460, 100, 160, 20);
        ...
        jLabel16.setBounds(460, 340, 150, 30);
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculationlayaerST.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculationlayaerST().setVisible(true);
            }
        });
    }
