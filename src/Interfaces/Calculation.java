...
public class Calculation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(650, 460, 120, 30);
        ...
        jButton2.setBounds(50, 420, 120, 30);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(460, 370, 120, 20);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(460, 130, 110, 30);
        ...
        jLabel9.setText("DCP");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(610, 410, 110, 30);
        ...
        jLabel11.setBounds(460, 330, 110, 30);
        ...
        jLabel14.setBounds(460, 260, 36, 15);
        ...
        jLabel16.setBounds(460, 290, 150, 30);
        ...
        jLabel18.setBounds(0, 0, 890, 500);
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     String name="Yellow maize meal";
      ...
      double mecost = (1F/3400)*3000*cost;
    ...
    try {
     ...
     Float cost = rs .getFloat("foodcost");
      ...
      double cpcost = (1F/11)*21*cost;
        double mecost = (1F/3200)*3000*cost;
...
if(co.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1/11)*21*cost;
       double mecost = (1F/7500)*3000*cost;
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     String name = "Coconut oil meal";
      double cpcost = (1F/20)*21*cost;
        double mecost = (1F/1750)*3000*cost;
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     String name = "Gingerly oil meal";
      double cpcost = (1F/32)*21*cost;
        double mecost = (1F/2400)*3000*cost;
         double cacost = (1/0.2F)*1*cost;
    ...
    try {
     ...
     String name = "Fish meal";
      double cpcost = (1F/72)*21*cost;
        double mecost = (1F/2750)*3000*cost;
...
try {
     ...
     String name = "Broken rice";
      double cpcost = (1F/7)*21*cost;
        double mecost = (1F/3050)*3000*cost;
         double cacost = (1/0.02F)*1*cost;
...
try {
     ...
     String name = "Hypro meal";
      double cpcost = (1F/63)*21*cost;
        double mecost = (1/3000F)*3000*cost;
    ...
    try {
     ...
     String name ="Wheat floir";
      double cpcost = (1F/15)*21*cost;
        double mecost = (1F/3000)*3000*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.1F)*0.5*cost;
