 ...
 * @author gavishka
 */
public class Calculation111 extends javax.swing.JFrame {

    Connection conn= null;
    
    public Calculation111() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(460, 360, 100, 20);
        ...
        jPanel1.add(lable);
        lable.setBounds(450, 90, 110, 30);

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel5.setText("Hypro meal ");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(610, 350, 110, 30);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel6.setText("Fish meal");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(610, 280, 110, 20);

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel7.setText("Molasses");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(450, 130, 110, 30);
        ...
        jLabel9.setText("DCP");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(610, 390, 110, 30);

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel10.setText("Broken rice ");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(610, 320, 110, 30);
        ...
        jLabel11.setBounds(460, 320, 110, 30);

        jLabel12.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel12.setText("Wheat floir ");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(460, 170, 110, 30);
        ...
        jLabel14.setBounds(460, 250, 36, 15);

        jLabel15.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel15.setText("Palm oil");
        jPanel1.add(jLabel15);
        jLabel15.setBounds(460, 220, 70, 15);

        jLabel16.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel16.setText("Shel powder ");
        jPanel1.add(jLabel16);
        jLabel16.setBounds(460, 280, 150, 30);
        ...
        jPanel1.add(po);
        po.setBounds(430, 210, 20, 21);
        jPanel1.add(hm);
        hm.setBounds(580, 350, 20, 21);
    ...
    // JOptionPane.showMessageDialog(null,cost);
     String name="Yellow maize meal";
      ...
      double mecost = (1F/3400)*2700*cost;
         double cacost = (1/0.02F)*1*cost;
          double availcost = (1/0.1F)*0.42*cost;
           double lyscost = (1/0.19F)*0.66*cost;
            double metcost = (1/0.25F)*0.58*cost;
    ...
    try {
     ...
     String name="Rice polish";
      //double cpcost = (1F/11)*21*cost;
        double mecost = (1F/3200)*27.0*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.45F)*0.42*cost;
           double lyscost = (1/0.47F)*0.66*cost;
            double metcost = (1/0.34F)*0.58*cost;
...
if(co.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1/11)*21*cost;
       double mecost = (1F/7500)*2700*cost;
 ...
 Float cost = rs .getFloat("foodcost");
     ...
     String name = "Coconut oil meal";
      //double cpcost = (1F/20)*21*cost;
        double mecost = (1F/1750)*2700*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.2F)*0.42*cost;
           double lyscost = (1/0.61F)*0.66*cost;
            double metcost = (1/0.56F)*0.58*cost;
...
if(gom.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1F/32)*21*cost;
        double mecost = (1F/2400)*2700*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.4F)*0.42*cost;
           double lyscost = (1/0.58F)*0.66*cost;
            double metcost = (1/1.33F)*0.58*cost;
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     String name = "Soyabean oil meal";
      //double cpcost = (1F/42)*21*cost;
        double mecost = (1F/2500)*2700*cost;
         double cacost = (1/0.25F)*1*cost;
          double availcost = (1/0.25F)*0.42*cost;
           double lyscost = (1/2.7F)*0.66*cost;
            double metcost = (1/1.4F)*0.58*cost;
   ...
   Float cost = rs .getFloat("foodcost");
     ...
     String name = "Fish meal";
      //double cpcost = (1F/72)*21*cost;
        double mecost = (1F/2750)*2700*cost;
         double cacost = (1F/5)*1*cost;
          double availcost = (1/2.5F)*0.42*cost;
           double lyscost = (1/5.2F)*0.66*cost;
            double metcost = (1F/3)*0.58*cost;
...
try {
 ...
 Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1F/7)*21*cost;
        double mecost = (1F/3050)*2700*cost;
         double cacost = (1/0.02F)*1*cost;
          double availcost = (1/0.04F)*0.42*cost;
           double lyscost = (1/0.28F)*0.66*cost;
            double metcost = (1/0.35F)*0.58*cost;
...
try {
    ...
    //  double cpcost = (1F/63)*21*cost;
        double mecost = (1/3000F)*2700*cost;
         double cacost = (1/2.9F)*1*cost;
          double availcost = (1/1F)*0.42*cost;
           double lyscost = (1/2.83F)*0.66*cost;
            double metcost = (1/1.22F)*0.58*cost;
     ...
     // double cpcost = (1/63)*21*cost;
        //double mecost = (1/3000)*3000*cost;
         double cacost = (1F/22)*1*cost;
          double availcost = (1F/17)*0.42*cost;
     ...
     // double cpcost = (1/1)*21*cost;
       // double mecost = (1/3000)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1/0.07F)*0.42*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            //double metcost = (1/1.22)*0.89*cost;
       ...
       // double mecost = (1/3000)*3000*cost;
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            double metcost = (1F/100)*0.58*cost;
     ...
     // double cpcost = (1/63)*21*cost;
        double mecost = (1F/2400)*2700*cost;
         double cacost = (1F/0.89)*1*cost;
          double availcost = (1/0.02)*0.42*cost;
          // double lyscost = (1/2.83)*1.25*cost;
           // double metcost = (1/1.22)*0.89*cost;
    ...
    try {
     ...
     String name ="Wheat floir";
      //double cpcost = (1F/15)*21*cost;
        double mecost = (1F/3000)*2700*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.1F)*0.42*cost;
           double lyscost = (1/0.3F)*0.66*cost;
            double metcost = (1/0.17F)*0.58*cost;
...
if(ll.isSelected()){
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1/63)*21*cost;
        ...
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*05*cost;
          double lyscost = (1F/100)*0.66*cost;
            //double metcost = (1/100)*0.89*cost;
...
if(sp.isSelected()){
    ...
    // double cpcost = (1/1)*21*cost;
        //double mecost = (1/7500)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1F/0.07)*0.42*cost;
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculation111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculation111().setVisible(true);
            }
        });
    }
