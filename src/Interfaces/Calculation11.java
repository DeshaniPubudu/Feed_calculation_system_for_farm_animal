 ...
 * @author gavishka
 */
public class Calculation11 extends javax.swing.JFrame {

    Connection conn= null;
    
    public Calculation11() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(610, 431, 120, 40);
        ...
        jButton2.setBounds(30, 431, 120, 40);
        ...
        jPanel1.add(co);
        co.setBounds(580, 130, 20, 21);

        jLabel12.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jPanel1.add(jLabel12);
        jLabel12.setBounds(80, 60, 110, 30);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel1.setText("Yellow mize mail ");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(460, 100, 80, 20);
    ...
    // JOptionPane.showMessageDialog(null,cost);
     String name="Yellow maize meal";
      //double cpcost = (1/8.7F)*21*cost;
      double mecost = (1F/3400)*2750*cost;
         double cacost = (1/0.02F)*1*cost;
          double availcost = (1/0.1F)*0.45*cost;
           double lyscost = (1/0.19F)*1.1*cost;
            double metcost = (1/0.25F)*0.82*cost;
   
         try {
             PreparedStatement pst = conn.prepareStatement("insert into information (food,mecost,cacost,availcost,lyscost,metcost)  values  (?,?,?,?,?,?)");
          ...
          pst.setString(1,name);
            ...
            pst.setDouble(5,lyscost);
            pst.setDouble(6,metcost);
...
if(rp.isSelected()){
   ...
   Float cost = rs .getFloat("foodcost");
     ...
     String name="Rice polish";
      //double cpcost = (1F/11)*21*cost;
        double mecost = (1F/3200)*2750*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.45F)*0.45*cost;
           double lyscost = (1/0.47F)*1.1*cost;
            double metcost = (1/0.34F)*0.82*cost;
...
if(co.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1/11)*21*cost;
       double mecost = (1F/7500)*2750*cost;
...
if (com.isSelected()){
     ...
     String name = "Coconut oil meal";
      //double cpcost = (1F/20)*21*cost;
        double mecost = (1F/1750)*2750*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.2F)*0.45*cost;
           double lyscost = (1/0.61F)*1.1*cost;
            double metcost = (1/0.56F)*0.82*cost;
...
if(gom.isSelected()){
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1F/32)*21*cost;
        double mecost = (1F/2400)*2750*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.4F)*0.45*cost;
           double lyscost = (1/0.58F)*1.1*cost;
            double metcost = (1/1.33F)*0.82*cost;
...
if(som.isSelected()){
  ...
  try {
     ...
     String name = "Soyabean oil meal";
      //double cpcost = (1F/42)*21*cost;
        double mecost = (1F/2500)*2750*cost;
         double cacost = (1/0.25F)*1*cost;
          double availcost = (1/0.25F)*0.45*cost;
           double lyscost = (1/2.7F)*1.1*cost;
            double metcost = (1/1.4F)*0.82*cost;
...
if(fm.isSelected()){
    ...
    try {
     ...
     String name = "Fish meal";
      //double cpcost = (1F/72)*21*cost;
        double mecost = (1F/2750)*2750*cost;
         double cacost = (1F/5)*1*cost;
          double availcost = (1/2.5F)*0.45*cost;
           double lyscost = (1/5.2F)*1.1*cost;
            double metcost = (1F/3)*0.82*cost;
...
try {
     ...
     // double cpcost = (1F/7)*21*cost;
        double mecost = (1F/3050)*2750*cost;
         double cacost = (1/0.02F)*1*cost;
          double availcost = (1/0.04F)*0.43*cost;
           double lyscost = (1/0.28F)*0.9*cost;
            double metcost = (1/0.35F)*0.71*cost;
...
try {
    ...
    //  double cpcost = (1F/63)*21*cost;
        double mecost = (1/3000F)*2750*cost;
         double cacost = (1/2.9F)*1*cost;
          double availcost = (1/1F)*0.45*cost;
           double lyscost = (1/2.83F)*1.1*cost;
            double metcost = (1/1.22F)*0.82*cost;
   ...
   Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1/63)*21*cost;
        //double mecost = (1/3000)*3000*cost;
         double cacost = (1F/22)*1*cost;
          double availcost = (1F/17)*0.45*cost;
...
if(sg.isSelected()){
   ...
   Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1/1)*21*cost;
       // double mecost = (1/3000)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1/0.07F)*0.45*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            //double metcost = (1/1.22)*0.89*cost;
       ...
       // double mecost = (1/3000)*3000*cost;
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            double metcost = (1F/100)*0.82*cost;
...
if(m.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1/63)*21*cost;
        double mecost = (1F/2400)*2750*cost;
         double cacost = (1F/0.89)*1*cost;
          double availcost = (1/0.02)*0.45*cost;
          // double lyscost = (1/2.83)*1.25*cost;
           // double metcost = (1/1.22)*0.89*cost;
...
if(wf.isSelected()){
    try {
     ...
     String name ="Wheat floir";
      //double cpcost = (1F/15)*21*cost;
        double mecost = (1F/3000)*2750*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.1F)*0.45*cost;
           double lyscost = (1/0.3F)*1.1*cost;
            double metcost = (1/0.17F)*0.82*cost;
...
if(ll.isSelected()){
  ...
  Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1/63)*21*cost;
        ...
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
          double lyscost = (1F/100)*1.1*cost;
            //double metcost = (1/100)*0.89*cost;
...
if(sp.isSelected()){
    ...
    // double cpcost = (1/1)*21*cost;
        //double mecost = (1/7500)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1F/0.07)*0.45*cost;
   ...
   /// meken uda                  
        ...
        /*   try {
            try {
                 ...
                 else { JOptionPane.showMessageDialog(null,"Please Selcet at lease one food ");}
            } catch (Exception e) {
               // JOptionPane.showMessageDialog(null,"Please Selcet at lease one food ");
            }
...
ShowResult1 re = new ShowResult1 ();
re.show();
dispose();
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculation11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculation11().setVisible(true);
            }
        });
    }
