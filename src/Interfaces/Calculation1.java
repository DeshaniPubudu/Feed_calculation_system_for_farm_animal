 ...
 * @author gavishka
 */
public class Calculation1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(670, 460, 120, 40);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(450, 100, 120, 20);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(620, 100, 80, 20);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(620, 220, 110, 30);

        lable.setBackground(new java.awt.Color(204, 255, 204));
        ...
        lable.setAutoscrolls(true);
        jPanel1.add(lable);
        lable.setBounds(440, 180, 110, 30);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(590, 380, 110, 30);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(590, 300, 110, 20);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(430, 220, 110, 30);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(590, 260, 150, 30);
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(460, 410, 110, 30);
        ...
        jLabel10.setBounds(590, 340, 110, 30);
        ...
        jLabel11.setBounds(430, 140, 110, 30);
        ...
        jLabel12.setBounds(440, 260, 110, 30);
        ...
        jLabel14.setBounds(460, 340, 36, 15);
        ...
        jLabel15.setBounds(440, 310, 70, 15);
        ...
        jLabel16.setBounds(420, 370, 150, 30);
        ...
        jLabel17.setBounds(600, 130, 110, 30);
        ...
        jLabel18.setBounds(0, 0, 900, 500);
     ...
     String name="Yellow maize meal";
      ...
      double mecost = (1F/3400)*2750*cost;
         double cacost = (1/0.02F)*1*cost;
          double availcost = (1/0.1F)*0.43*cost;
           double lyscost = (1/0.19F)*0.9*cost;
            double metcost = (1/0.25F)*0.71*cost;
      ...
      //double cpcost = (1F/11)*21*cost;
        double mecost = (1F/3200)*2750*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.45F)*0.43*cost;
           double lyscost = (1/0.47F)*0.9*cost;
            double metcost = (1/0.34F)*0.71*cost;
      ...
      //double cpcost = (1F/20)*21*cost;
        double mecost = (1F/1750)*2750*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.2F)*0.43*cost;
           double lyscost = (1/0.61F)*0.9*cost;
            double metcost = (1/0.56F)*0.71*cost;
    ...
    try {
     ...
     // double cpcost = (1F/32)*21*cost;
        double mecost = (1F/2400)*2750*cost;
         double cacost = (1/0.2F)*1*cost;
          double availcost = (1/0.4F)*0.43*cost;
           double lyscost = (1/0.58F)*0.9*cost;
            double metcost = (1/1.33F)*0.71*cost;
      ...
      //double cpcost = (1F/42)*21*cost;
        double mecost = (1F/2500)*2750*cost;
         double cacost = (1/0.25F)*1*cost;
          double availcost = (1/0.25F)*0.43*cost;
           double lyscost = (1/2.7F)*0.9*cost;
            double metcost = (1/1.4F)*0.71*cost;
      ...
      //double cpcost = (1F/72)*21*cost;
        double mecost = (1F/2750)*2750*cost;
         double cacost = (1F/5)*1*cost;
          double availcost = (1/2.5F)*0.43*cost;
           double lyscost = (1/5.2F)*0.9*cost;
            double metcost = (1F/3)*0.71*cost;
    ...
    //  double cpcost = (1F/63)*21*cost;
        double mecost = (1/3000F)*2750*cost;
         double cacost = (1/2.9F)*1*cost;
          double availcost = (1/1F)*0.43*cost;
           double lyscost = (1/2.83F)*0.9*cost;
            double metcost = (1/1.22F)*0.71*cost;
     ...
     // double cpcost = (1/63)*21*cost;
        //double mecost = (1/3000)*3000*cost;
         double cacost = (1F/22)*1*cost;
          double availcost = (1F/17)*0.43*cost;
     ...
     // double cpcost = (1/1)*21*cost;
       // double mecost = (1/3000)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1/0.07F)*0.43*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            //double metcost = (1/1.22)*0.89*cost;
       ...
       // double mecost = (1/3000)*3000*cost;
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            double metcost = (1F/100)*0.71*cost;
     ...
     // double cpcost = (1/63)*21*cost;
        double mecost = (1F/2400)*2750*cost;
         double cacost = (1F/0.89)*1*cost;
          double availcost = (1/0.02)*0.43*cost;
          // double lyscost = (1/2.83)*1.25*cost;
           // double metcost = (1/1.22)*0.89*cost;
     ...
     String name ="Wheat floir";
      //double cpcost = (1F/15)*21*cost;
        double mecost = (1F/3000)*2750*cost;
         double cacost = (1/0.04F)*1*cost;
          double availcost = (1/0.1F)*0.43*cost;
           double lyscost = (1/0.3F)*0.9*cost;
            double metcost = (1/0.17F)*0.71*cost;
...
if(ll.isSelected()){
    try {
     ...
     // double cpcost = (1/63)*21*cost;
        ...
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
          double lyscost = (1F/100)*0.9*cost;
            //double metcost = (1/100)*0.89*cost;
...
if(sp.isSelected()){
    ...
    // double cpcost = (1/1)*21*cost;
        //double mecost = (1/7500)*3000*cost;
         double cacost = (1F/38)*1*cost;
          double availcost = (1F/0.07)*0.43*cost;
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculation1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculation1().setVisible(true);
            }
        });
    }
