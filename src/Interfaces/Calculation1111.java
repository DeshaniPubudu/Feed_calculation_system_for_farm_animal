 ...
 * @author gavishka
 */
public class Calculation1111 extends javax.swing.JFrame {

    Connection conn= null;
    
    public Calculation1111() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(770, 450, 120, 40);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(460, 350, 110, 20);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(610, 230, 110, 30);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(610, 360, 110, 30);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel6.setText("Fish meal");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(610, 310, 110, 20);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(610, 270, 150, 30);
        ...
        jLabel11.setBounds(460, 310, 110, 30);
        ...
        jLabel16.setBounds(460, 270, 150, 30);
        ...
        jPanel1.add(hm);
        hm.setBounds(580, 360, 20, 21);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/select foods_1.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
   ...
   Float cost = rs .getFloat("foodcost");
    // JOptionPane.showMessageDialog(null,cost);
     String name="Yellow maize meal";
      double cpcost = (1/8.7F)*18*cost;
      double mecost = (1F/3400)*2400*cost;
         double cacost = (1/0.02F)*0.45*cost;
         // double availcost = (1/0.1F)*0.5*cost;
           //double lyscost = (1/0.19F)*1.25*cost;
            //double metcost = (1/0.25F)*0.89*cost;
   
         try {
               PreparedStatement pst = conn.prepareStatement("insert into information (food,cpcost,mecost,cacost)  values  (?,?,?,?)");
...
if(rp.isSelected()){
    ...
    try {
     ...
     String name="Rice polish";
      double cpcost = (1F/11)*18*cost;
        double mecost = (1F/3200)*2400*cost;
         double cacost = (1/0.04F)*0.45*cost;
          //double availcost = (1/0.45F)*0.5*cost;
           //double lyscost = (1/0.47F)*1.25*cost;
            //double metcost = (1/0.34F)*0.89*cost;
...
if(co.isSelected()){
    ...
    Float cost = rs .getFloat("foodcost");
     ...
     // double cpcost = (1/11)*21*cost;
       double mecost = (1F/7500)*2400*cost;
...
if (com.isSelected()){
     ...
     String name = "Coconut oil meal";
      double cpcost = (1F/20)*18*cost;
        double mecost = (1F/1750)*2400*cost;
         double cacost = (1/0.2F)*0.45*cost;
         // double availcost = (1/0.2F)*0.5*cost;
          // double lyscost = (1/0.61F)*1.25*cost;
           // double metcost = (1/0.56F)*0.89*cost;
...
if(gom.isSelected()){
    ...
    try {
     ...
     String name = "Gingerly oil meal";
      double cpcost = (1F/32)*18*cost;
        double mecost = (1F/2400)*2400*cost;
         double cacost = (1/0.2F)*0.45*cost;
         // double availcost = (1/0.4F)*0.5*cost;
           //double lyscost = (1/0.58F)*1.25*cost;
            //double metcost = (1/1.33F)*0.89*cost;
  ...
  try {
   ...
   Float cost = rs .getFloat("foodcost");
     ...
     String name = "Soyabean oil meal";
      double cpcost = (1F/42)*18*cost;
        double mecost = (1F/2500)*24000*cost;
         double cacost = (1/0.25F)*0.45*cost;
          //double availcost = (1/0.25F)*0.5*cost;
           //double lyscost = (1/2.7F)*1.25*cost;
            //d5ouble metcost = (1/1.4F)*0.89*cost;
...
if(fm.isSelected()){
    ...
    try {
     ...
     String name = "Fish meal";
      double cpcost = (1F/72)*18*cost;
        double mecost = (1F/2750)*2400*cost;
         double cacost = (1F/5)*0.45*cost;
         // double availcost = (1/2.5F)*0.5*cost;
           //double lyscost = (1/5.2F)*1.25*cost;
            ////double metcost = (1F/3)*0.89*cost;
...
try {
     ...
     String name = "Broken rice";
      double cpcost = (1F/7)*18*cost;
        double mecost = (1F/3050)*2400*cost;
         double cacost = (1/0.02F)*0.45*cost;
          //double availcost = (1/0.04F)*0.5*cost;
           //double lyscost = (1/0.28F)*1.25*cost;
            //double metcost = (1/0.35F)*0.89*cost;
...
try {
     ...
     String name = "Hypro meal";
      double cpcost = (1F/63)*18*cost;
        double mecost = (1/3000F)*2400*cost;
         double cacost = (1/2.9F)*0.45*cost;
          //double availcost = (1/1F)*0.5*cost;
           //double lyscost = (1/2.83F)*1.25*cost;
            //double metcost = (1/1.22F)*0.89*cost;
        ...
        //double mecost = (1/3000)*3000*cost;
         ...
         // double availcost = (1F/17)*0.5*cost;
           ...
           // double metcost = (1/1.22)*0.89*cost;
                ...
                PreparedStatement pst = conn.prepareStatement("insert into information (food,cacost)  values  (?,?)");
     pst.setString(1,name);
           // pst.setDouble(2,cpcost);
           // pst.setDouble(3,mecost);
...
if(sg.isSelected()){
    try {
     ...
     String name ="Shell grit";
      double cpcost = (1/1)*18*cost;
       // double mecost = (1/3000)*3000*cost;
         double cacost = (1F/38)*0.45*cost;
         // double availcost = (1/0.07F)*0.5*cost;
           //double lyscost = (1/2.83)*1.25*cost;
            //double metcost = (1/1.22)*0.89*cost;

     
                     PreparedStatement pst = conn.prepareStatement("insert into information (food,cpcost,cacost)  values  (?,?,?)");
     pst.setString(1,name);
           pst.setDouble(2,cpcost);
           // pst.setDouble(3,mecost);
       ...
       // double mecost = (1/3000)*3000*cost;
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
           //double lyscost = (1/2.83)*1.25*cost;
           // double metcost = (1F/100)*0.89*cost;

            PreparedStatement pst = conn.prepareStatement("insert into information (food)  values  (?)");
     pst.setString(1,name);
          // pst.setDouble(2,cpcost);
          // // pst.setDouble(3,mecost);
           // pst.setDouble(4,cacost);
...
if(m.isSelected()){
    ...
    try {
     ...
     // double cpcost = (1/63)*21*cost;
        double mecost = (1F/2400)*2400*cost;
         double cacost = (1F/0.89)*0.45*cost;
         // double availcost = (1/0.02)*0.5*cost;
          // double lyscost = (1/2.83)*1.25*cost;
           ...
           PreparedStatement pst = conn.prepareStatement("insert into information (food,mecost,cacost)  values  (?,?,?)");
     pst.setString(1,name);
          // pst.setDouble(2,cpcost);
          pst.setDouble(2,mecost);
           pst.setDouble(3,cacost);
...
if(wf.isSelected()){
    try {
     ...
     String name ="Wheat floir";
      double cpcost = (1F/15)*18*cost;
        double mecost = (1F/3000)*2400*cost;
         double cacost = (1/0.04F)*0.45*cost;
          //double availcost = (1/0.1F)*0.5*cost;
         //  double lyscost = (1/0.3F)*1.25*cost;
         //   double metcost = (1/0.17F)*0.89*cost;
...
if(ll.isSelected()){
    try {
     ...
     // double cpcost = (1/63)*21*cost;
        ...
        // double cacost = (1/2.9)*1*cost;
          //double availcost = (1/1)*0.5*cost;
         // double lyscost = (1F/100)*1.25*cost;
            //double metcost = (1/100)*0.89*cost;
...
ShowResult11 re = new ShowResult11 ();
re.show();
dispose();                   
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculation1111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculation1111().setVisible(true);
            }
        });
    }
